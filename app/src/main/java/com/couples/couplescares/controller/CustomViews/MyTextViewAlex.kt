package com.couples.couplescares.controller.CustomViews
...
class MyTextViewAlex : AppCompatTextView {
    ...
    fun setCustomFont(ctx: Context, asset: String?): Boolean {
        ...
        try {
            typeface = Typeface.createFromAsset(ctx.assets, "AlexBrush-Regular.ttf")
